...
SRC location : New files added into src
...
NOTE: 1. All the files are currently hard-coded to generate the respective output files. 
In other words, the src files *do not* look at the argument to determine the name of output file to generate. Similarly the names of input files and directories are hard-coded.
